...
| [`data/partijen.json`](data/partijen.json) | 83 partijen met laag, mandaatsoort, functies, toegankelijkheid voor een gemeente, omschrijving, toelichting en adres. Het adres (`url`) is ook de terugval voor verwijzingen vanuit de rest van de kennisbank, zie `bronnen.json` op de root |
