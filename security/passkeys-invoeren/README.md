...
| `img/` | Twee infographics: waarom push en number matching niet genoeg zijn, en waarom passkeys de grootste dreiging stoppen |
...
![Push en number matching zijn te onderscheppen](img/mfa-push-en-number-matching.jpg)
...
![Account takeover via phishing is de grootste dreiging, bij jou en bij je leveranciers](img/account-takeover-passkeys.png)
